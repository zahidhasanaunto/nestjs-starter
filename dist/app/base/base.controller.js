...
const CleanParams_decorator_1 = require("../decorators/CleanParams.decorator");
class BaseController {
    constructor(_modelService, _modelRelations) {
        this._modelService = _modelService;
        this._modelRelations = _modelRelations;
...
__decorate([
    common_1.Get(),
    CleanParams_decorator_1.CleanParams(),
